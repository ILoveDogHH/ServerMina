...
import j2cache.redis.RedisPubSubClusterPolicy;
import j2cache.util.CacheException;
import j2cache.util.ConfigKit;
...
public class J2Cache {
    ...
    private static final int LEVEL1 = CacheConstans.LEVEL1;
    private static final int LEVEL2 = CacheConstans.LEVEL2;
